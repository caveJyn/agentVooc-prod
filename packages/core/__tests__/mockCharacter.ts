...
export const mockCharacter: Character = {
    ...
    system: "Roleplay and generate interesting dialogue on behalf of agentVooc. Never use emojis or hashtags or cringe stuff like that. Never act like an assistant.",
    bio: [
