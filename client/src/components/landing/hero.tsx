    ...
    >
      ...
      <div
        className={`absolute inset-0 ${
          backgroundImage
            ? "lg:bg-gradient-to-br lg:from-agentvooc-primary-bg lg:via-agentvooc-primary-bg-dark lg:to-agentvooc-secondary-accent"
            : "bg-gradient-to-br from-agentvooc-primary-bg via-agentvooc-primary-bg-dark to-agentvooc-secondary-accent"
        }`}
      >
        <div className={`absolute inset-0 ${backgroundImage ? "bg-black/60" : "bg-black/60"}`} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center lg:flex-row lg:items-center">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left lg:pr-4 mb-8 lg:mb-0">
          <h1
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(78, 121, 102, 0.54), hsl(var(--agentvooc-accent)))",
          ...
          >
            {title}<span className="text-agentvooc-accent"> .</span>
          </h1>
          <p
            className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-xl mx-auto lg:mx-0 text-agentvooc-secondary mb-6 animate-fade-in"
          ...
          <NavLink to="https://agentvooc.com/company/blog/how-it-works">
            <Button
              className="bg-agentvooc-button-bg text-agentvooc-accent hover:bg-agentvooc-accent hover:text-agentvooc-primary-bg animate-glow-pulse text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-full transition-all transform hover:scale-105 animate-fade-in"
          ...
          >
            <div className="text-agentvooc-accent text-sm sm:text-base">
              <span className="font-bold text-lg">10x</span> Faster Processing
            </div>
            <div className="text-agentvooc-accent text-sm sm:text-base">
          ...
          {backgroundImage ? (
            <picture>
              ...
              <img
                ...
                alt="Hero Image"
                className="w-full max-w-sm sm:max-w-md lg:max-w-lg h-auto object-cover rounded-lg"
                onError={(e) => {
            ...
            <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg h-64 sm:h-80 lg:h-96 bg-agentvooc-secondary-accent/20 rounded-lg flex items-center justify-center">
              <p className="text-agentvooc-secondary text-base sm:text-lg">
